...
public enum Positions {
    ...
    RED_DOWN(new Pose2d(-5.25 * 12, -2.75 * 12, Math.toRadians(0))),
    BLUE_DOWN(new Pose2d(-5.25 * 12, 2.75 * 12, Math.toRadians(0))),
    ...
    // Ball Locations
    RED_GPP(new Pose2d(-3 * 12, -5 * 12, Math.toRadians(270))),
    RED_PGP(new Pose2d(-1 * 12, -5 * 12, Math.toRadians(270))),
    RED_PPG(new Pose2d(12, -5 * 12, Math.toRadians(270))),
    BLUE_PPG(new Pose2d(-3 * 12, 5 * 12, Math.toRadians(90))),
    BLUE_PGP(new Pose2d(-1 * 12, 5 * 12, Math.toRadians(90))),
    BLUE_GPP(new Pose2d(12, 5 * 12, Math.toRadians(90))),
    // Camera Offset
